...
const Cart = () => {
  ...
  const deleteCartItemFromCart = (id:number) => {
          ...
          <ul className="space-y-4">
            {
              cart.map((item) => (
                ...
                <Image
                  ...
                  width={64}
                  height={64}
                  className="size-16 flex items-center  object-contain "
                />
                ...
                <p className="mt-0.5 text-xs text-primary-500 bg-primary-100 p-1 rounded">$ {item.product.attributes.price}</p>
  
                  <button onClick={() => {deleteCartItemFromCart(item.id)}}
